class StatisticCalculator:
    ...
    def get_disease_stat_array(self, people_distr_list, number_of_days):
        ...
        people_distr_dict = {
            ...
            'n4': people_distr_list[3],  # количество повторно заболевшиз людей
        ...
        for day_num in range(number_of_days):
            ...
            n2_new = round(self.n2(people_distr_dict.get('n1'), people_distr_dict.get('n2'), people_distr_dict.get('n5')))
            n3_new = round(self.n3(people_distr_dict.get('n2'), people_distr_dict.get('n3'), people_distr_dict.get('n4')))
            ...
            n6_new = round(self.n6(people_distr_dict.get('n2'), people_distr_dict.get('n4'), people_distr_dict.get('n6')))
            ...
            for group_name in people_distr_dict:
                ...
                k += 1
            for dots_array_num in range(len(dots_array_list)):
                dots_arrays_list[dots_array_num] = new_n_list[dots_array_num]
        return dots_array_num
