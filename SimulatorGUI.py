...
# Form implementation generated from reading ui file 'D:\Users\Пользователь\Documents\GitHub\EpidemicSimulation\window.ui'
#
...
"}")
        ...
        self.n_in_2 = QtWidgets.QLabel(self.centralwidget)
        self.n_in_2.setGeometry(QtCore.QRect(10, 370, 61, 41))
        font = QtGui.QFont()
        font.setFamily("Lucida Bright")
        font.setPointSize(18)
        font.setBold(False)
        font.setWeight(50)
        self.n_in_2.setFont(font)
        self.n_in_2.setToolTipDuration(-1)
        self.n_in_2.setStyleSheet("background-color: qradialgradient(spread:pad, cx:0.284, cy:0.551, radius:0.5, fx:0.307, fy:0.540045, stop:0 rgba(255, 162, 11, 0), stop:1 rgba(255, 255, 255, 0));")
        self.n_in_2.setIndent(-1)
        self.n_in_2.setObjectName("n_in_2")
        self.days_num_input_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.days_num_input_2.setGeometry(QtCore.QRect(70, 370, 161, 41))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(14)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.days_num_input_2.setFont(font)
        self.days_num_input_2.setStyleSheet("QLineEdit{\n"
"background-color: qradialgradient(spread:pad, cx:0.5, cy:0.5, radius:0.5, fx:0.5, fy:0.5, stop:0 rgba(7, 248, 240, 102), stop:1 rgba(27, 255, 255, 104));\n"
"font: 14pt \"MS Shell Dlg 2\";\n"
"color: rgb(0, 255, 255);\n"
"border: 1px solid rgb(255, 255, 255);\n"
"border-radius: 5px\n"
"}")
        self.days_num_input_2.setText("")
        self.days_num_input_2.setMaxLength(12)
        self.days_num_input_2.setFrame(True)
        self.days_num_input_2.setObjectName("days_num_input_2")
        self.discribe_n5_2 = QtWidgets.QLabel(self.centralwidget)
        self.discribe_n5_2.setGeometry(QtCore.QRect(240, 380, 251, 20))
        self.discribe_n5_2.setStyleSheet("background-color: rgb(85, 85, 255);\n"
"color: rgb(0, 255, 255);\n"
"border-radius: 5px;\n"
"color: rgb(180, 255, 249);")
        self.discribe_n5_2.setObjectName("discribe_n5_2")
        self.info_button = QtWidgets.QPushButton(self.centralwidget)
        self.info_button.setGeometry(QtCore.QRect(820, 620, 40, 40))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.n_in_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" color:#18fff0;\">N : </span></p></body></html>"))
        self.days_num_input_2.setToolTip(_translate("MainWindow", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))
        self.discribe_n5_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">количество дней</p></body></html>"))
